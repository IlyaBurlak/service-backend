...
export class CreateUserDto {
  ...
  @ApiProperty({ description: 'Является ли гостем', example: false, required: false })
  @IsBoolean()
  @IsOptional()
  isGuest?: boolean;
}
...
export class UpdateUserDto extends PartialType(CreateUserDto) {
  ...
  @ApiProperty({ description: 'Имя пользователя', example: 'Петр', required: false })
  @IsString()
  @IsOptional()
  name?: string;

  @ApiProperty({ description: 'Фамилия пользователя', example: 'Петров', required: false })
  @IsString()
  @IsOptional()
  surname?: string;
}
